...
import { getChatById, getMessagesByChat, deleteChat, updateChatTitle } from '$lib/server/db';
...
export const GET: RequestHandler = async ({ params, platform, locals }) => {
	...
	const messages = await getMessagesByChat(platform.env.DB, params.id);

	return json({ conversation: chat, messages });
};
